    ...
    <div className={`min-h-screen ${darktheme 
      ...
      <div className="flex flex-1">
        ...
        <div className="flex-1 p-6 overflow-auto">
          <div className="mb-6">
            <h1 className={`text-3xl font-bold ${darktheme ? "text-white" : "text-gray-800"}`}>Manage Users</h1>
            <p className={`${darktheme ? "text-gray-400" : "text-gray-600"}`}>View and manage all registered users</p>
          </div>
              ...
              <div className="overflow-x-auto rounded-xl">
                <table className="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody className={`${darktheme ? "divide-gray-700" : "divide-gray-200"}`}>
                    {users.map((userData) => (
                      <tr key={userData._id} className={`${darktheme ? "hover:bg-gray-700/50" : "hover:bg-gray-50"}`}>
